...
Submitted to: Mr McKenzie
Date of submission: January 26, 2015
'''
#MODULE IMPORTS--------------
from random import*
from pygame import*
...
sayings=["Welcome to Cat's Paint! Begin by hovering on a tool to use or get information on it",
         ...
         "Load tool: Loads selected image onto canvas",
         ...
         "Now playing: Monster Cat",
         "Now playing:Flight of the Cats",
         "Now playing:Silent Cats",
         "Now playing:The Cat Came Back",
         "Now playing:Techno Cat",
         "Now playing:Nyan Cat Dubstep",
         "Canvas Fill Tool: Click to make desired colour of canvas"]
...
canvasFillRect=Rect(645,687,70,70)
canvasFillCol=(255,255,255)
...
while running:
    ...
    if tab=="tools":
        ...
        #TOOL USE-----------------------
            if tool=="bucket":#could not get this tow work :(
                bucket(col)
                bucketCol=selected
            else:
                bucketCol=(255,255,255)
    ...
    if tab=="shapes":
        ...
        #Canvas Fill
        draw.rect(screen,(col),canvasFillRect)
        ...
        if mb[0]==1 or mb[2]==1 and canvasRect.collidepoint(mx,my):
            ...
            if canvasFillRect.collidepoint(mx,my):
               saying=34
               if mb[0]==1:
